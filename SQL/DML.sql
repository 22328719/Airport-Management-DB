...
VALUES
    ('123-45-6789', 'Ahmet Yilmaz', 'AEU1001', 1,
    ...
    ('345-67-8901', 'Ayse Demir',   'ASA2001', 2,
...
VALUES
    ('TK101', 'TC-BOE01', 'Istanbul', 'Ankara',
     '2026-06-01 08:00:00', '2026-06-01 09:10:00',
     '2026-06-01 08:05:00', '2026-06-01 09:15:00',
     'Arrived'),
    ('TK205', 'TC-AIR02', 'Adana', 'Izmir',
     '2026-06-02 14:30:00', '2026-06-02 16:00:00',
     NULL, NULL,
     'Scheduled'),
    ('TK890', 'TC-BOE03', 'Antalya', 'Berlin',
     '2026-06-03 22:00:00', '2026-06-04 01:30:00',
     NULL, NULL,
     'Cancelled');
